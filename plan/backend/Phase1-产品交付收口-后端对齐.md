...
- [ ] **B1-1～B1-3、B1-5、B1-6** 完成；登录与 staging 联调可验收（**B1-6** 见 **`plan/backend/dev/B1-6-数据库迁移与Schema演进.md`**）  
...
- **Phase 1 门禁**：推进 **B1-5、B1-6** 与 **P1-1 字段一致** 核对，周会对照 **`Phase0-收口与Phase1开启.md` §5**。
...
| v0.2 | 2026-04-07 | Phase 1 门禁对齐 **B1-6**（迁移与 Schema） |
